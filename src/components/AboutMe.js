                ...
                <Row className='align-items-center' id='AboutMeRow'>
                    ...
                    <Col id='AboutMeColDescription' xs={12} md={6}>
                        <div id='HeidiDescription'>
                            ...
                            <p>Heidi has a dedication to serving the LGBTQ2S+ community as an ally, and an advocate. She has specialized in gender and sexuality empowerment since 2016, and is currently working on research focused on trans youth's experiences of disordered eating behaviour. </p>
